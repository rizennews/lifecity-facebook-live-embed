 ...
 */
 ...
 function lifecity_facebook_enqueue_scripts() {
     ...
     if (is_admin()) {
         ...
         wp_enqueue_script('lifecity-facebook-admin-scripts', plugin_dir_url(__FILE__) . 'js/admin-scripts.js', array('jquery-ui-accordion'), null, true);
     }
 }
     ...
     if ($live_video_id) {
         ...
         <div id="lifecity-facebook-container">
             ...
             <div id="lifecity-facebook-chat" style="display:none;">
                 <!-- Replace this with your Facebook Live chat embed code -->
             </div>
         </div>
         <?php
         return ob_get_clean();
